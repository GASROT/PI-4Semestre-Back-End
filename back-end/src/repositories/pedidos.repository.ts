...
import type { AddItemPedidoDto, CreatePedidoDto, UpdateStatusPedidoDto } from '../modules/pedidos/pedidos.dto';
...
export const pedidosRepository = {
  ...
  updateStatus(id: string, payload: UpdateStatusPedidoDto) {
